...
from home.models import Instrument, Student, Tutor, Availablity, Booking
...
class BookingForm(forms.Form):
    #availablity = Availablity.objects.get(pk=self.bookingid.kwargs[booking_id])
    #def __init__(self, *args, **kwargs):
    #    self.fields.intial = self.data
    #student = forms.request.user
    avaiblablity = forms.BooleanField(label='I want to book this lesson.')
